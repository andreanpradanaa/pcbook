...
func startTestgRPCServer(t *testing.T, laptopStore *InMemoryLaptopStore, imageStore *DiskImageStore, ratingStore *InMemoryRatingStore) string {
...
func startTestgRPCClient(t *testing.T, addr string) pb.LaptopServiceClient {
...
func TestClientCreateLaptop(t *testing.T) {
	...
	addr := startTestgRPCServer(t, laptopStore, nil, nil)
	grpcClient := startTestgRPCClient(t, addr)
	...
	res, err := grpcClient.CreateLaptop(context.Background(), &req)
	require.NoError(t, err)
...
func TestClientSearchLaptop(t *testing.T) {
	...
	serverAddress := startTestgRPCServer(t, laptopStore, nil, nil)
	laptopClient := startTestgRPCClient(t, serverAddress)
...
func TestClientUploadImage(t *testing.T) {
	...
	serverAddress := startTestgRPCServer(t, laptopStore, imageStore, nil)
	laptopClient := startTestgRPCClient(t, serverAddress)

	imagePath := fmt.Sprintf("%s/foto.png", testImageFolder)
...
func TestClientRateLaptop(t *testing.T) {
	...
	serverAddress := startTestgRPCServer(t, laptopStore, nil, ratingStore)
	laptopClient := startTestgRPCClient(t, serverAddress)
